...
function openAddUserModal() {
            ...
            m.style.zIndex = '100';            m.classList.add('active');
...
function openEditUserModal(fullName) {
            ...
            m2.style.zIndex = '100';            m2.classList.add('active');
            m2.removeAttribute('inert');
        }
...
function closeUserModal() {
            ...
            m.style.zIndex = '';            m.classList.remove('active');
...
function openMygesModal(name) {
            ...
            const mm = document.getElementById('mygesModal');
